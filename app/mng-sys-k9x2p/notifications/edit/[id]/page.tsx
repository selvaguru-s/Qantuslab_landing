...
import { getNotificationById, updateNotification } from '@/lib/notifications';
...
export default function EditNotificationPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    const fetchNotification = async () => {
      const notif = await getNotificationById(params.id);
      ...
      setFormData({
        ...
        expiresInHours: notif.expiresInHours,
        active: notif.active,
      });
      setLoading(false);
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await updateNotification(params.id, {
    ...
    return (
      <div className="container mx-auto p-8">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-lg text-muted-foreground">Loading notification...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto p-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold mb-2">Edit Notification</h1>
